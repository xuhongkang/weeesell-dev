        ...
        <div class="goods-total">
          <ul>
            ...
            ">
              ...
              <span class="txt">
                {{ orderInfo.order.priceDetailDTO.discountPrice | unitPrice("Kz") }}
              </span>
            </li>
      ...
      columns: [
        ...
        },
        {
          ...
          render: (h, params) => {
            ...
            return h("div", this.$options.filters.unitPrice(params.row.unitPrice, "Kz"));
          },
        },
        ...
        },
        {
          ...
          minWidth: 100,
          render: (h, params) => {
            return h("div", this.$options.filters.unitPrice(params.row.flowPrice, "Kz"));
          },
        },
      ],
      data: [], // 表单数据
