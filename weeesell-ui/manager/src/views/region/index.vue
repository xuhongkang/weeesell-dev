  ...
  <Card>
      ...
      <div class="form">
        ...
        >
          ...
          <FormItem label="行政区划级别" prop="cityCode">
            ...
            >
              <Radio  label="country">国家</Radio>
              <Radio  label="province">省份</Radio>
              <Radio  label="city">市</Radio>
              <Radio  label="district">区县</Radio>
              <Radio  label="street">街道</Radio>
            </RadioGroup>
          </FormItem>
    ...
    <Modal v-model="modalFlag" title="添加" @on-ok="submit">
      <Form ref="addValidate" :model="addValidate" :label-width="100">
        ...
        <FormItem label="行政地区路径" prop="path">
          <Input v-model="addValidate.path" />
        </FormItem>
      </Form>
    </Modal>
  </Card>
