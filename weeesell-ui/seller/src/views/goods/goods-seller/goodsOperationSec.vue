      ...
      <Form ref="baseInfoForm" :label-width="120" :model="baseInfoForm" :rules="baseInfoFormRule">
        <div class="base-info-item">
          ...
          <div class="form-item-view">
            ...
            <FormItem v-if="baseInfoForm.salesModel == 'PRESALE'" class="form-item-view-el" label="销售规则"
                      prop="wholesaleRule">
              <div class="form-item-view-wholesale">
                <div>
                  <Table :columns="wholesaleColumns" :data="wholesaleData" border>
          ...
          <div class="form-item-view">
            ...
            <FormItem class="form-item-view-el" label="PC商品描述" prop="intro" style="width: 100%">
              ...
              <editor ref="editor" v-model="baseInfoForm.intro" :init="{ ...initEditor, height: '800px' }" :api-key="apiKey" openXss>
              </editor>
            ...
            <FormItem class="form-item-view-el" label="移动端描述" prop="skuList" style="width: 100%">
              <editor ref="editor" v-model="baseInfoForm.mobileIntro" :init="{ ...initEditor, height: '800px' }" :api-key="apiKey" openXss>
              </editor>
            </FormItem>
          </div>
...
export default {
  ...
  data() {
    ...
    return {
      regular,
      initEditor,
      apiKey: "jxvr67jvahyfg03ygbjyie4ibcs5ncgxdrk08akelylw2xn5",
      total: 0,
      goodsVideo: "",
      showContent: false,
      listImages: [],
