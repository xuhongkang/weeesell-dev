      ...
      <Row>
        ...
        <template v-if="orderInfo.order.needReceipt == true && orderInfo.receipt">
          ...
          <div class="div-item">
            ...
            <div class="div-item-right">
              <span v-if="orderInfo.receipt.receiptPrice">Kz</span>{{
      ...
      <div class="goods-total">
        <ul>
          <li>
            ...
            <span class="txt">{{
              orderInfo.order.priceDetailDTO.goodsPrice | unitPrice("Kz")
            }}</span>
          </li>
          <li v-if="orderInfo.order.priceDetailDTO.discountPrice && orderInfo.order.priceDetailDTO.discountPrice > 0">
            <span class="label">优惠金额：</span>
            <span class="txt"> {{ orderInfo.order.priceDetailDTO.discountPrice | unitPrice('Kz') }} </span>
          </li>
          ...
          <li v-if="orderInfo.order.priceDetailDTO.couponPrice && orderInfo.order.priceDetailDTO.couponPrice > 0">
            ...
            <span class="txt"> {{ orderInfo.order.priceDetailDTO.couponPrice | unitPrice('Kz') }} </span>
          </li>
          <li
          ...
          <li>
            ...
            <span class="txt">{{
              orderInfo.order.freightPrice | unitPrice("Kz")
            }}</span>
          </li>
...
<!--            <InputNumber style="width: 100%" v-model="modifyPriceForm.orderPrice" size="large" :min="0.01" :max="99999">-->
            <InputNumber style="width: 100%" v-model="modifyPriceForm.orderPrice" size="large" :min="0.01" :max="99999999999999999999">
      ...
      columns: [
        ...
        },
        {
          ...
          render: (h, params) => {
            return h(
              "div",
              this.$options.filters.unitPrice(params.row.flowPrice, "Kz")
            );
          },
        },
      ],
