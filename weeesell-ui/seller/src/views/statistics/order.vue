            ...
            <div class="transaction-item" v-for="(item,index) in transactionList" :key="index">
              ...
              <div class="transaction-card" v-if="item.label=='订单'">
                ...
                <div class="card-item">
                  ...
                  <div class="card-item-value">{{overViewList.orderAmount || 0 | unitPrice('Kz')}}</div>
                </div>
                <div class="card-item">
                ...
                <div class="card-item">
                  ...
                  <div class="card-item-value">{{ overViewList.paymentAmount || 0 | unitPrice('Kz')}}</div>
                </div>
              ...
              <div class="transaction-card" v-if="item.label=='退单'">
                ...
                <div class="card-item">
                  ...
                  <div class="card-item-value">{{overViewList.refundOrderPrice || 0 | unitPrice('Kz')}}</div>
                </div>
