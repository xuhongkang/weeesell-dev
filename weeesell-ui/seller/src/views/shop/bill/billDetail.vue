      ...
      <div>
        ...
        <div class="bill-detail-price">
          <div class="flex bill-item">
            <span>
              <p>退单金额</p>
              <p class="theme_color">-{{bill.refundPrice || 0 | unitPrice('Kz')}}</p>
            </span>
            <span>
              <p>平台收取佣金</p>
              <p class="theme_color">-{{bill.commissionPrice || 0 | unitPrice('Kz')}}</p>
            </span>
            <span>
              <p>分销返现支出</p>
              <p class="theme_color">-{{bill.distributionCommission || 0  | unitPrice('Kz')}}</p>
            </span>
            <span>
              <p>退单平台优惠券补贴返还</p>
              <p class="theme_color">-{{bill.siteCouponRefundCommission || 0  | unitPrice('Kz')}}</p>
            </span>
             </div>
            <div class="flex bill-item">
            <span>
              <p>平台优惠券补贴</p>
              <p class="increase-color">+{{bill.siteCouponCommission || 0  | unitPrice('Kz')}}</p>
            </span>
              <span>
        		    <p>退单产生退还佣金金额</p>
        		    <p class="increase-color">+{{bill.refundCommissionPrice || 0  | unitPrice('Kz')}}</p>
        		  </span>
        		  <span>
        		    <p>退单分销返现返还</p>
        		    <p class="increase-color">+{{bill.distributionRefundCommission || 0  | unitPrice('Kz')}}</p>
        		  </span>
            <span>
              <p>积分结算金额</p>
              <p class="increase-color">+{{bill.pointSettlementPrice || 0  | unitPrice('Kz')}}</p>
            </span>
            <span>
              <p>砍价商品结算金额</p>
              <p class="increase-color">+{{bill.kanjiaSettlementPrice || 0  | unitPrice('Kz')}}</p>
            </span>
            </div>
          </div>
        </div>
      ...
      orderColumns: [
        ...
        },
        {
          ...
          render: (h, params) => {
            return h(
              "div",
              this.$options.filters.unitPrice(params.row.commissionPrice, "Kz")
            );
          },
        },
        {
        ...
        },
		{
		  ...
		  render: (h, params) => {
		    if(params.row.siteCouponCommission == null){
		      ...
		      return h(
		        "div",
		        this.$options.filters.unitPrice(params.row.siteCouponCommission, "Kz")
		      );
		    }
        ...
        },
        {
          ...
          render: (h, params) => {
            return h(
              "div",
              this.$options.filters.unitPrice(params.row.billPrice, "Kz")
            );
          },
        },
      ],
      ...
      refundColumns: [
        ...
        },
        {
          ...
          render: (h, params) => {
            return h(
              "div",
              this.$options.filters.unitPrice(params.row.finalPrice, "Kz")
            );
          },
        },
        {
          ...
          render: (h, params) => {
            if (params.row.commissionPrice) {
              ...
              return h("div", this.$options.filters.unitPrice(0, "Kz"));
            }
          },
        },
