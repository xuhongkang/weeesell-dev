<template>
  <div class="forget-password" @click='$refs.verify.show = false'>
    ...
    <div class="logo-box">
      <img
        :src="$store.state.logoImg" style="width: 80px;"
        @click="$router.push('/')"
      />
      <div>{{$t('xgma')}}</div>
    </div>
    <div class="login-container">
        ...
        >
          ...
          <FormItem>
            <Button @click="verifyBtnClick" long :type="verifyStatus?'success':'default'">{{verifyStatus?$t('yztg'):$t('djwc')}}</Button>
          </FormItem>
          <FormItem>
            <Button type="error" @click="next" :loading="loading" long>{{$t('xyb')}}</Button>
          </FormItem>
        </Form>
        <Form
          ref="form"
        ...
        >
          <FormItem prop="password">
            <i-input
              ...
              clearable
              placeholder="Please enter at least six passwords"
            >
          ...
          <FormItem>
            <Button type="error" size="large" @click="handleSubmit" :loading="loading1" long>{{$t('submit')}}</Button>
          </FormItem>
        </Form>
        <!-- 拼图验证码 -->
        <Verify
          ...
          @change="verifyChange"
        ></Verify>
        <div class="login-btn"><a @click="$router.push('login')">{{$t('qwdl')}}</a></div>
    </div>
  </div>
</template>
