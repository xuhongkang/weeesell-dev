<template>
  <div class="cart" @click="couponAvailable = false">
    ...
    <div class="width_1200 logo">
      <div>
        <router-link to="/"><img :src="$store.state.logoImg" style="height: 75px;width: 85px;"/></router-link>
        <div>
        ...
        <div class="cart-goods-footer">
          ...
          <div>
            ...
            <div class="ml_20 save-price">
              已节省<span>{{
                priceDetailDTO.discountPrice | unitPrice("Kz")
              }}</span>
            </div>
            <div class="ml_20 total-price">
              总价（不含运费）:
              <div>{{ priceDetailDTO.flowPrice | unitPrice("Kz") }}</div>
            </div>
