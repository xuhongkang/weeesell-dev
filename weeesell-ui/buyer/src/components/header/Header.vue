...
<!--                <li @click="goUserCenter('/home/Favorites')">{{ $t('login') }}</li>-->
                <li @click="signOutFun">退出登录</li>
              </ul>
            </transition>
          </div>
        </li>
        <li @click="goUserCenter('/home/MyOrder')"><span class="nav-item">{{ $t('wodedd') }}</span></li>
        <li @click="goUserCenter('/home/MyTracks')"><span class="nav-item">{{ $t('wodezj') }}</span></li>
        <li @click="goUserCenter('/home/MsgList')"><span class="nav-item">{{ $t('wodexx') }}</span></li>
        <li ><span class="nav-item"><Lang class="drop-items"></Lang></span></li>
                  ...
                  <div class="shopping-cart-info">
                    ...
                    <div class="shopping-cart-detail">
                      ...
                      <div class="shopping-price">
                        {{ item.purchasePrice | unitPrice('Kz') }}
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <li>
          <span class="nav-item" @click="shopEntry">{{ $t('dprz') }}</span>
        </li>
        <li>
          <span class="nav-item" @click="goUserCenter('/home/Favorites')">{{ $t('wdsc') }}</span>
        </li>
      </ul>
    </div>
  </div>
