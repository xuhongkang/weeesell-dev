      ...
      <div class="box box1">
        <div class="bargain">
            ...
            <div class="goods-config">
              ...
              <div class="flex price-box">
                <div class="purchase-price">
                  当前:<span>Kz{{ activityData.surplusPrice == 0 ? this.bargains.purchasePrice :  activityData.surplusPrice | unitPrice}}</span>
                </div>
                <div class="max-price">原价:<span>Kz{{ bargainDetail.price | unitPrice}}</span>
          ...
          <div class="bargain-progress">
            ...
            <div class="flex tips">
              <div>已砍{{cutPrice}}Kz</div>
              <div>还剩{{activityData.surplusPrice}}Kz</div>
            </div>
          </div>
          <!-- 参与砍价 -->
        ...
        <div class="bargain">
          ...
          <div class="user-item flex" v-if="logData.length !=0 " v-for="(item,index) in logData" :key="index">
            ...
            <div class="user-config flex">
              ...
              <div class="save">砍掉：<span>Kz{{item.kanjiaPrice | unitPrice}}</span></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <u-modal title="恭喜您砍掉了" v-model="Bargaining" mask-close-able :show-confirm-button="false"
        ...
        <view class="slot-content">
          <u-count-to :start-val="0" ref="uCountTo" font-size="100" :color="lightColor" :end-val="kanjiaPrice"
            :decimals="2" :autoplay="autoplay"></u-count-to><span class="price">Kz</span>
        </view>
      </u-modal>
      <!-- 帮砍 -->
