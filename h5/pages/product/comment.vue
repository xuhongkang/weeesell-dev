  ...
  <view class="comment">
    <view class="top-tab">
      <view class="tab-btn" :v-if="commentDetail">
        <view @click="select(0)" :class="{ cur: selectIndex == 0 }">{{$t('quanbu')}}</view>
        <view @click="select(1)" :class="{ cur: selectIndex == 1 }">{{$t('haoping')}}{{ commentDetail.good }}</view>
        <view @click="select(2)" :class="{ cur: selectIndex == 2 }">{{$t('zhongping')}}{{ commentDetail.moderate }}</view>
        <view @click="select(3)" :class="{ cur: selectIndex == 3 }">{{$t('chaping')}}{{ commentDetail.worse }}</view>
        <view @click="select(4)" :class="{ cur: selectIndex == 4 }">{{$t('youtu')}}{{ commentDetail.haveImage }}</view>
      </view>
    </view>
    <!-- 评价 -->
