  ...
  <view class="user">
    ...
    <view class="header"  @click="userDetail">
      ...
      <view class="head-2" v-else>
        <view class="user-name">{{$t('zc')}}</view>
      </view>
...
<!--        <u-col text-align="center" span="4" @click="navigateTo('/pages/mine/myTracks')">
      ...
      <view class="order">
        ...
        <!-- <view class="order-item"  style="margin-top: -45px;" @click="navigateTo('/pages/order/myOrder?status=0')"> -->
          <div class="bag bag1">
            <u-icon name="order" size="35" color="#fff"></u-icon>
          </div>
          <view>{{this.$t('wodedd')}}</view>
        </view>
      </view>
    </div>
    <!-- 常用工具 -->
