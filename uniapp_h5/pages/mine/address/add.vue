    ...
    <div class="uForm">
      <u-form :border-bottom="false" :model="form" ref="uForm" :error-type="['toast']" :rule="rules">
        ...
        <u-form-item class="border" label="consignee" label-width="130" prop="name">
          <u-input v-model="form.name" clearable placeholder="Please enter the recipient's name" />
        </u-form-item>

        <u-form-item label="Mobile number" label-width="130" prop="mobile">
          <u-input v-model="form.mobile" type="number" maxlength="9" placeholder="Please enter the recipient's mobile phone number" />
        </u-form-item>
        <u-form-item label="Region" label-width="130" prop="___path">
          <div  @click="showPicker" >
            {{ form.___path || 'Please select your region' }}
          </div>
        </u-form-item>
      ...
      <m-city :provinceData="list" headTitle="Region selection" ref="cityPicker" @funcValue="getpickerParentValue" pickerSize="4">
      </m-city>
