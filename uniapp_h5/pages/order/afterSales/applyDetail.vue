          ...
          <view class="goods-item-view" @click="navgiateToGoodsDetail(serviceDetail)">
            ...
            <view class="goods-info">
              ...
              <view class="goods-price">
                <view class="price"> Kz{{ serviceDetail.flowPrice | unitPrice }}</view>
                <view>
