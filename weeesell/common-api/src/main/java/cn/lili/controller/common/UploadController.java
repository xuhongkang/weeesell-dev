...
public class UploadController {
    ...
    public ResultMessage<Object> upload(MultipartFile file,
        ...
        try {
            ...
            newFile.setFileKey(fileKey);
            newFile.setUrl(result);
			//newFile.setUrl("https://lilishop-oss.oss-cn-beijing.aliyuncs.com/STORE/1376417684140326912//a790ad4e74f4429ba69592ce8460675c.png");
            newFile.setCreateBy(authUser.getUsername());
            newFile.setUserEnums(authUser.getRole().name());
            //如果是店铺，则记录店铺id
            if (authUser.getRole().equals(UserEnums.STORE)) {
		...
		//return ResultUtil.data("https://lilishop-oss.oss-cn-beijing.aliyuncs.com/STORE/1376417684140326912//a790ad4e74f4429ba69592ce8460675c.png");
    }
}
