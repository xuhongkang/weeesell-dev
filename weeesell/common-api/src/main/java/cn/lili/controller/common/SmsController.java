...
public class SmsController {
    ...
    public ResultMessage getSmsCode(
            ...
            @PathVariable VerificationEnums verificationEnums) throws ExecutionException, InterruptedException {
        if(mobile.length() != 9){
            return ResultUtil.success(ResultCode.USER_PHONE_NOT_EXIST);
        }
